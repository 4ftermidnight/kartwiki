package br.com.aftermidnight.kartwiki.util.cdi;
...
// Classe usada para injetar os beans no converter. Mas as novas versões do jsf isso já não é mais necessário. Já da pra usar o @Inject
// cdi 2.2.11.Final, jsf 2.2
