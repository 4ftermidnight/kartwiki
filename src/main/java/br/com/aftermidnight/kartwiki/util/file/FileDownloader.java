package br.com.aftermidnight.kartwiki.util.file;
...
public class FileDownloader {
	...
	public static File gravaArquivoDeURL(String stringUrl, String pathLocal, String fileName) {
		try {
...
//			String nomeArquivoLocal = url.getPath();
			String nomeArquivoLocal = fileName;
